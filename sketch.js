...
if(fruit !== null){
if (dist(fruit.position.x,fruit.position.y,s1.position.x,s1.position.y)<80 && S1===false){
  S1 = true
  s1.destroy()
  score = score+5
}

if (dist(fruit.position.x,fruit.position.y,s2.position.x,s2.position.y)<80 && S2===false){
S2 = true
s2.destroy()
score = score+5
}
